...
$(".updateGuarantor1").on("click", function(event){
  event.preventDefault();

  var form = document.forms.namedItem("updateG1Form");
  var formData = new FormData(form);
      ...
      $.ajax({
          ...
          success: function(data){
            if(data == 1){
              ...
              Fnon.Hint.Success('Guarantor-1 Updated Successfully.', {
                position: 'center-center', // 'right-top', 'right-center', 'right-bottom', 'left-top', 'left-center', 'left-bottom', 'center-top', 'center-center', 'center-bottom'
                animation: 'slide-left', //'fade', 'slide-top', 'slide-bottom', 'slide-right' and 'slide-left'
               callback:function(){
                // callback
...
$(".updateGuarantor2").on("click", function(event){
  event.preventDefault();

  var form = document.forms.namedItem("updateG2Form");
  var formData = new FormData(form);
      ...
      $.ajax({
          ...
          success: function(data){
            if(data == 1){
              ...
              Fnon.Hint.Success('Guarantor-2 Updated Successfully.', {
                position: 'center-center', // 'right-top', 'right-center', 'right-bottom', 'left-top', 'left-center', 'left-bottom', 'center-top', 'center-center', 'center-bottom'
                animation: 'slide-left', //'fade', 'slide-top', 'slide-bottom', 'slide-right' and 'slide-left'
               callback:function(){
                // callback
  ...
  $(".btnAddGuarantor").on("click", function(event){
    event.preventDefault();
  
    var form = document.forms.namedItem("createGuarantor");
    var formData = new FormData(form);
    var index = $('#index').val();
    var phone = $('#userPhone').val();
      ...
      if(index==1){
        $.ajax({
          ...
          success: function(data){
            if(data == 1){
              Fnon.Hint.Success('First Guarantor created successfully. Let\'s create Guarantor-2', {
                position: 'center-center', // 'right-top', 'right-center', 'right-bottom', 'left-top', 'left-center', 'right-top', 'center-top', 'center-center', 'center-bottom'
                animation: 'slide-left', //'fade', 'slide-top', 'slide-bottom', 'slide-right' and 'slide-left'
               callback:function(){
                // callback
      ...
      var url = "../../create-guarantor/"+phone+'/2';
        ...
        $.ajax({
          ...
          success: function(data){
            if(data == 1){
              ...
              Fnon.Hint.Success('All Guarantors now created successfully. Good Job!', {
                position: 'center-center', // 'right-top', 'right-center', 'right-bottom', 'left-top', 'left-center', 'left-bottom', 'center-top', 'center-center', 'center-bottom'
                animation: 'slide-left', //'fade', 'slide-top', 'slide-bottom', 'slide-right' and 'slide-left'
               callback:function(){
                // callback
