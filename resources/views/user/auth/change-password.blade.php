...
<p class="version">Version 1.5</p>
  ...
  <div class="col-md-12" id="app">
    ...
    <x-slot  name="logo">
        <a href="index.html"><img  src="{{URL::to('/')}}/public/assets/img/LOGO-23D.png" style="width: 200px; height:50px; " alt="" class="thumbnail-sm img-responsive mt-2" ></a>
...
<div class="text-danger text-center" id='error'></div>
        ...
        @endif
<h4><b>You must change your passsword to continue</b></h4><br>
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4">
                ...
                <input id="password" class="block mt-1 w-full password" type="password" name="password"  required autofocus />
                 <x-jet-input id="userid" class="block mt-1 w-full" type="hidden" name="userid"  value="{{Auth::user()->id}}" />
            </div>
...
$(document).ready(function(){
  ...
  $(".reset").click(function(e){
    ...
    var answer = $("#answer").val();
         ...
         type:"post",  
         data:{password:password,id:id,question:question,answer:answer},
