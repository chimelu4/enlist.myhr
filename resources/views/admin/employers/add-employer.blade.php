        ...
        <section class="section">
          ...
          <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page">Add New Employer</li>
                      </ol>
                    </nav>
          ...
          <div class="section-body">
                ...
                <div class="card">
                  ...
                  <div class="col-md-12"  >
                  <form name="addEmployer" enctype="multipart/form-data" novalidate=""  >
                  @csrf
                    ...
                    <div class="row">
                          ...
                          <div class="col-md-8">
                             <div class="text-center mb-2" > <h6 >Company Information</h6></div>
                          <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control"   name="oline" id="oline">
                          <div class="invalid-feedback">
                  ...
                  <div class="card-footer text-right">
                    <button type="submit" class="btn btn-primary btnAddEmployer mr-2" id="btnAddEmployer"><i class="fa fa-spinner fa-spin spin"></i>Submit</button>
...
"use strict";
  $(document).ready(function(){
    $('.spin').hide();
//adding jobrole
$("#btnAddEmployer").on("click", function(event){
      event.preventDefault();
      $('.spin').show();
var form = document.forms.namedItem("addEmployer");
...
$.ajax({
  type:'post',
    url:'{{URL::to('/')}}/admin/create/employer',
    data:formData, 
    processData: false,
    contentType: false,
    success: function(data){
      if(data == 1){
        $('.spin').hide();
        Fnon.Hint.Success('Employer added successfully. Well Done!', {
