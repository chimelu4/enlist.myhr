          ...
          <div class="section-body">
                ...
                <div class="card">
                    ...
                    <div id="accordion"  >
                      <div class="accordion" >                          
                        ...
                        <div class="accordion-header" role="button" data-toggle="collapse" data-target="#panel-body-1" aria-expanded="true"    >
                          <h4>Employer's Personal Data</h4>
                        </div>
                  ...
                  <div class="card-footer text-right">
                    <button type="submit" class="btn btn-primary btnUpdateEmployer mr-2" id="btnUpdateEmployer"><i class="fa fa-spinner fa-spin spin"></i>Update</button>
...
"use strict";
  $(document).ready(function(){
    $('.spin').hide();
//adding jobrole
$("#btnUpdateEmployer").on("click", function(event){
...
$.ajax({
  type:'post',
    ...
    success: function(data){
      if(data == 1){
        $('.spin').hide();
        Fnon.Hint.Success('Employer updated successfully. Good Job!', {
