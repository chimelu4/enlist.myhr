        ...
        <section class="section">
          ...
          <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page" >All Candidates</a></li>                        
                      </ol>
                    </nav>
...
<div class="card">
                  ...
                  <a  href="{{URL::to('admin/add/candidate')}}" class="btn btn-primary mb-4" >Add New</a>
               <div class="container">
               <div class="row">
               <div class="col-md-12">
               ...
               <div class="table-responsive">
                      ...
                      <a  href="{{URL::to('/admin/edit-candidate')}}/{{$data->id}}"  class=" dropdown-item  ">Edit</a>        
                             <a href=""  data-id="{{$data->id}}"   class=" dropdown-item  delete-candidate ">Delete</a>
...
location.reload(false);
  ...
  $('.delete-candidate').click(function(e){
          ...
          if (confirmalert == true) {
                  ...
                  $.ajax({  
                        url:"{{URL::to('/')}}/admin/delete/candidate/"+id,  
                        type:"get",  
                        success:function(data)  
                        {  
                          if(data == 1){
